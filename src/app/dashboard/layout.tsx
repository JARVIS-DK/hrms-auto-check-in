...
export default function DashboardLayout({
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      <header className="shrink-0 bg-card border-b border-border px-6 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <h1 className="text-base font-bold">HRMS Auto Check-in</h1>
        </div>
        <button
      ...
      <div className="flex-1 flex overflow-hidden">
        <nav className="shrink-0 w-52 bg-card border-r border-border p-3 space-y-0.5 overflow-y-auto">
          {NAV_ITEMS.map((item) => (
            <Link
              key={item.href}
              href={item.href}
