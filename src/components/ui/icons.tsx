/**
 * Shared icons — one stroke language for the whole app.
 * 24×24 viewBox, round caps, stroke 2 (2.25 for denser badges).
 */
...
function base({ size = 16, className, stroke = "currentColor", strokeWidth = 2 }: IconProps) {
  return {
...
export function PowerIcon(props: IconProps) {
  return (
    <svg {...base({ size: props.size ?? 16, ...props })}>
...
export function HolidayIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 2v6" />
      <path d="M4.9 9.5A9 9 0 0 1 12 8a9 9 0 0 1 7.1 1.5" />
...
/** Circular tinted backdrop for attendance actions in tables and cards. */
