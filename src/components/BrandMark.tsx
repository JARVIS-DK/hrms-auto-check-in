...
export default function BrandMark({
  ...
  return (
    <svg
      ...
      height={size}
      viewBox="0 0 40 40"
      className={`shrink-0 drop-shadow-[0_8px_16px_rgba(61,156,240,0.18)] ${className}`}
    >
      <defs>
        <linearGradient id={`${uid}-tile`} x1="8" y1="4" x2="34" y2="38" gradientUnits="userSpaceOnUse">
          <stop stopColor="#4aabf5" />
          <stop offset="0.55" stopColor="#3d9cf0" />
          <stop offset="1" stopColor="#2bb887" />
        </linearGradient>
      ...
      <circle cx="29.2" cy="29.2" r="5.35" fill="#2ecf9a" />
      <path
